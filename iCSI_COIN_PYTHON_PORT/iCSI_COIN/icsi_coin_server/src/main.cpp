...
uint256 hashGenesisBlock("0x73cd78da723ef620ac01d399a1430e131fd6c38caf0577727d24f1a32ad09cfe");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(509134573); // iCSICOIN: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "iCSICOIN Signed Message:\n";
...
{
    // iCSICOIN: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // iCSICOIN: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 902400; // iCSICOIN: 3.5 days
static const int64 nTargetSpacing = 120; // iCSICOIN: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // iCSICOIN: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // iCSICOIN: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // iCSICOIN: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x25922b3d93ea4e675585208ec77022405d8395ee6562104c14f0504bfb0fe053");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "iCSI Coin: Taking over the planet one token at a time!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e8021173391c099128b54cfb13fee84b134fff10f4eb57fe928feb26ec8663ca91993a6754a96c775f8d8f114c3e9e8db6d6d4a9e87f293fafe99baad471db6f1f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1690889645;
        block.nBits    = 509134573;
        block.nNonce   = 4023128374;

        if (fTestNet)
        {
            block.nTime    = 1690889645;
            block.nNonce   = 984922924;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xff51cbdd5ebc601b57b7c006965093d3d43c39b4d12259eef6c41bbbf9451cd6"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // iCSICOIN: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("iCSICOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("iCSICOINMiner : ProcessBlock, block not accepted");
    }
